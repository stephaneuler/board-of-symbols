...
/**
 * The enummeration of all signal types. Each type has a description, a tool tip
 * text and a short form. The Board uses this information to fill its menu. Any
 * new type is therefore included automatically in the menu. The short forms are
 * used to specify the signal type in receiveMessage() and other methods.
...
public enum SymbolType {
	CIRCLE, SQUARE, DIAMOND, STAR, PLUS, VLINE, HLINE, BAR, BLOCK, UP, DOWN, TRIANGLE_LD, TRIANGLE_RD, TRIANGLE_LU,
	TRIANGLE_RU, DICE_1, DICE_2, DICE_3, DICE_4, DICE_5, DICE_6, DOT, RANDOM, NONE;
	...
	private static void updateShortForms() {
		...
		shortForm.setProperty(".", texts.get(DOT)); 
	}
	...
	/**
	 * Set the symbol texts using a resource bundle and overwriting the defaults in
	 * German.
	 * 
